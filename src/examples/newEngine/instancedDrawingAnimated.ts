import { Context, InstancedElementsBundle, Index, Program, AttributeData, renderLoop, ElementsBundle, InstancedAttributeData } from '../../engine2/engine.core';
import { boxE } from '../../utils/shapes';
import { flatten2, flatten3 } from '../../utils/math';
...
`), {
    ...
    'a_translation': new InstancedAttributeData(new Float32Array(flatten2(translations)), 'vec4', true, 1)
}, {}, {},
'triangles',
...
renderLoop(100, (tDelta: number) => {
    ...
    bundle.updateAttributeData(context, 'a_translation', new Float32Array(flatten2(newTranslations)));
    bundle.draw(context);
});